...
module.exports = {
  ...
  CreateValidator: [
    body('name').isLength({ min: 2, max: 10 }).withMessage('最短2個字，最長10個字。'),
    body('price').isNumeric().withMessage('須為數字。'),
    body('description').isLength({ min: 6, max: 50 }).withMessage('最少6個字，最長50字。'),
